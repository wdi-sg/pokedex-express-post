...
// ****************   add new type to specific pokemon *********************
...
// ****************   post page after adding new type   ********************
      ...
      if (obj.pokemon[i].name == addToPoke) {
        ...
        if (obj.pokemon[i].type.includes(addType)) {
          ...
          <p style="display: inline;">Click</p> 
            <form action="/${addToPoke}" method="GET">
              <input type="submit" value="here"/>
            </form>
          <p style="display: inline;">to see the pokemon's details!</p>`)
        } else {
          ...
          <html>
          <body>
          <h1>${addType} type have been added to the pokemon ${addToPoke}!</h1><br><br>
          <p style="display: inline;">Click</p>
...
//  *************   post page after adding new pokemon   **************
