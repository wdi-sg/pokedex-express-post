  ...
  backgroundColor: '#D3D3D3',
    ...
    return (
      <html>
        <body>
          <div>
            <h1>Edit {this.props.pokemonData.name} !</h1>
            <form method="POST" action={"/pokemon/edit/"+this.props.index+'?_method=PUT'}>
                <table>
                <tr>
                <td>Image</td>
                <td>
                ...
                <tr>
                <td>Candy Count</td>
                <td><input name="candy_count" value={this.props.pokemonData.candy_count} /></td>
                </tr>
                <tr>
                <td>Egg</td>
                <td><input name="egg" value={this.props.pokemonData.egg} /></td>
                </tr>
                <tr>
                <td>Average Spawns</td>
                <td><input name="avg_spawns" value={this.props.pokemonData.avg_spawns} /></td>
                </tr>
                <tr>
                <td>Spawn Time</td>
                <td><input name="spawn_time" value={this.props.pokemonData.spawn_time} /></td>
                </tr>
                <tr>
                <td></td>
